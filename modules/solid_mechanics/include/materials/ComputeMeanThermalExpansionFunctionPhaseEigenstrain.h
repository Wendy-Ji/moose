 ...
 */
template <bool is_ad>
class ComputeMeanThermalExpansionFunctionPhaseEigenstrainTempl
  : public ComputeMeanThermalExpansionEigenstrainBaseTempl<is_ad>
{
public:
  static InputParameters validParams();

  ComputeMeanThermalExpansionFunctionPhaseEigenstrainTempl(const InputParameters & parameters);
...
protected:
  ...
  // const std::vector<Function> & _thermal_expansion_functions;

  const std::vector<FunctionName> _thermal_expansion_functions_names;
  std::vector<const PiecewiseLinear *> _thermal_expansion_functions;

  const Real & _thexp_func_ref_temp;
  // const ArrayVariableValue & _phase;
};

typedef ComputeMeanThermalExpansionFunctionPhaseEigenstrainTempl<false>
    ComputeMeanThermalExpansionFunctionPhaseEigenstrain;
typedef ComputeMeanThermalExpansionFunctionPhaseEigenstrainTempl<true>
    ADComputeMeanThermalExpansionFunctionPhaseEigenstrain;
