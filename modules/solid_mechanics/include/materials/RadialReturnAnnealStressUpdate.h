...
/**
 * RadialReturnAnnealStressUpdate computes the radial return stress increment for
 ...
 * The stress increment computed by RadialReturnAnnealStressUpdate is used by
...
template <bool is_ad>
class RadialReturnAnnealStressUpdateTempl : public StressUpdateBaseTempl<is_ad>,
                                      public SingleVariableReturnMappingSolutionTempl<is_ad>
{
public:
  static InputParameters validParams();

  RadialReturnAnnealStressUpdateTempl(const InputParameters & parameters);
...
typedef RadialReturnAnnealStressUpdateTempl<false> RadialReturnAnnealStressUpdate;
typedef RadialReturnAnnealStressUpdateTempl<true> ADRadialReturnAnnealStressUpdate;
